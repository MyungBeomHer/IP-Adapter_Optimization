...
def main():
    ...
    image_encoder_layerNorm = [p for n,p in image_encoder.named_parameters() if "norm" in n] #0.168960M
    ...
    for epoch in range(0, args.num_train_epochs):
        ...
        if epoch % 10 == 0:
            ...
            accelerator.save_state(save_path)
                ...
                #                         os.path.join(args.output_dir, f"image_encoder_tuning_LN_epoch{epoch}"),
